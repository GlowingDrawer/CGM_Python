...
class DataMonitorPage(QWidget):
    ...
    def init_ui(self):
        ...
        self.volt_aric_btn = QPushButton("电压-尿酸图表")
        self.volt_ascrobic_btn = QPushButton("电压-抗坏血酸图表")
        self.voltage_chart_btn = QPushButton("电压-葡萄糖图表")

        # 设置按钮样式
        self.time_chart_btn.setMinimumHeight(30)
        self.volt_aric_btn.setMinimumHeight(30)
        self.volt_ascrobic_btn.setMinimumHeight(30)
        ...
        chart_switch_layout.addWidget(self.volt_aric_btn)
        chart_switch_layout.addWidget(self.volt_ascrobic_btn)
        ...
        self.data_table.setHorizontalHeaderLabels(["时间(秒)","尿酸", "抗坏血酸", "葡萄糖值", "电压", "接收时间"])
        ...
        self.volt_aric_btn.clicked.connect(lambda: self.switch_chart(1))
        self.volt_ascrobic_btn.clicked.connect(lambda: self.switch_chart(2))
        self.voltage_chart_btn.clicked.connect(lambda: self.switch_chart(3))
    ...
    def init_volt_uric_chart(self):
        ...
        self.voltage_chart.setTitle(f"电压-{tableTitle}关系图")
        ...
        self.voltage_glucose_series.setName(f"{tableTitle}值")
    ...
    def init_volt_ascrobic_chart(self):
        tableTitle = "抗坏血酸"
        """初始化电压-尿酸值图表"""
        voltage_chart_widget = QWidget()
        voltage_layout = QVBoxLayout(voltage_chart_widget)
    ...
    def update_data(self, data):
        ...
        # 提取数据
        seconds = data.get("Seconds", 0) / 1000
